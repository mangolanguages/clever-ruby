...
module Clever
  class District
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'goals_enabled')
        self.goals_enabled = attributes[:'goals_enabled']
      end
    end
    ...
    def valid?
      ...
      goals_enabled_validator = EnumAttributeValidator.new('String', ['Y', 'N', ''])
      return false unless goals_enabled_validator.valid?(@goals_enabled)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] goals_enabled Object to be assigned
    def goals_enabled=(goals_enabled)
      validator = EnumAttributeValidator.new('String', ['Y', 'N', ''])
      unless validator.valid?(goals_enabled)
        fail ArgumentError, 'invalid value for "goals_enabled", must be one of #{validator.allowable_values}.'
      end
      @goals_enabled = goals_enabled
    end
    ...
    def hash
      [id, name, mdr_number, nces_id, sis_type, state, last_sync, error, pause_start, pause_end, launch_date, portal_url, login_methods, district_contact, goals_enabled].hash
    end
